...
# ── Step 11: Min-Max scaling on FEATURES only ─────────────────────────────────
print("\n" + "=" * 65)
print("STEP 11: MIN-MAX SCALING ON FEATURES [0, 1]")
print("=" * 65)

scaler = MinMaxScaler(feature_range=(0, 1))
df_labeled[final_features] = scaler.fit_transform(df_labeled[final_features])
print(f"  Scaled {len(final_features)} features to [0, 1].")
